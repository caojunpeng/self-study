...
!function(a, b) {
    ...
    function u(a, b, c, d) {
        ...
        !(b.forceMoveForward && d < c.currentIndex)) {
            ...
            A(a, b, c),
            P(a, b, c, d, e),
            a.triggerHandler("stepChanged", [d, e])) : a.find(".steps li").eq(e).addClass("error"),
            !0
        }
    }
    function v(a, b) {
    ...
    function A(b, c, d) {
        if (d.stepCount > 0) {
            ...
            if (!c.enableContentCache || !e.contentLoaded)
                switch (r($, e.contentMode)) {
                case $.iframe:
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul class="pagenum" role="menu" aria-label="{2}">{3}</ul></{0}>'
    ...
    function P(b, c, d, e, f) {
        ...
        case ab.slideLeft:
            ...
            j.css("left", q + "px")._showAria().animate({
                left: 0
            }, i).promise();
            break;
        default:
