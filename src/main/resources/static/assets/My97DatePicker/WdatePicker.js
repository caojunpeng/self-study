...
(function() {
	...
	function B() {
		...
		obj = {
			...
			show : function() {
				var A = X[O].getElementsByTagName("div"), $ = 100000;
	...
	function D($) {
		...
		if ($dp && $dp.cal && !$dp.eCont && $dp.dd && _ != $dp.el
	...
	function K(H, $) {
		...
		if (!$dp.dd
			...
			var B = "<iframe style=\"width:1px;height:1px\" src=\""
					+ _.$dpPath
					+ "My97DatePicker.html\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
			if ($dp.eCont) {
				...
				$dp.dd.innerHTML = B;
				V[O].body.appendChild($dp.dd, V[O].body.firstChild);
